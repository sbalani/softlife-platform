...
const NAV: { label: string; href?: string; soon?: boolean; adminOnly?: boolean; mobileOnly?: boolean; icon: ReactNode }[] = [
  ...
  { label: "Remote control", href: "/remote-control", icon: <svg viewBox="0 0 24 24" className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M8 5a7 7 0 108 0"/><path d="M12 2v8"/></svg> },
  ...
  { label: "Action Report", href: "/change-log", adminOnly: true, icon: <svg viewBox="0 0 24 24" className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M4 4h16v16H4z"/><path d="M8 9h8M8 13h8M8 17h5"/></svg> },
  ...
  { label: "Users", href: "/users", adminOnly: true, icon: <svg viewBox="0 0 24 24" className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="1.8"><circle cx="9" cy="8" r="3.5"/><path d="M2.5 20a6.5 6.5 0 0113 0"/><path d="M17 5.5a3.5 3.5 0 010 7M22 20a6 6 0 00-4.5-8.5"/></svg> },
